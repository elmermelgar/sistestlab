...
class CreateCustomersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('customers', function (Blueprint $table) {
            ...
            $table->string('trade_name', 127)->nullable();
        ...
        c.origin_center, c.trade_name, c.nit, c.nrc, c.business, a.photo, a.comment, a.created_at, a.updated_at 
        ...
        begin
            ...
            insert into customers(account_id, juridical_person, origin_center, trade_name, nit, nrc, business) 
                values(new.account_id, new.juridical_person, new.origin_center, new.trade_name, new.nit, new.nrc, 
        ...
        $tg_customer$
        begin
            update customers set (juridical_person, origin_center, trade_name, nit, nrc, business) = 
            (new.juridical_person, new.origin_center, new.trade_name, new.nit, new.nrc, new.business) where id = old.id;
