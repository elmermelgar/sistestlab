<div class="row">
    ...
    <div class="col-sm-12" id="logo_boleta"
        ...
        <div class="col-sm-4"><img class="img-responsive avatar-view" alt="Boleta" title="Testlab" style="max-height: 60px; margin: auto"
                                   src="{{'/storage/images/'.Auth::user()->account->sucursal->imagen->file_name}}"></div>
        <div class="col-sm-4"></div>

    </div>
    <div class="col-sm-12" style="text-align: center"><h3 style="font-size: 14px" id="test"><b>INFORME DE RESULTADOS DE LABORATORIO
            </b></h3></div>
</div>