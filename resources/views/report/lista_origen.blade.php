...
@section('content')
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li>Lista de centros de origen</li>
        </ol>
    </div>
    ...
    <div class="row">
        <div class="col-xs-8 col-xs-offset-2">
            <div class="x_panel">
                <div class="x_title">
                    <h3>Lista de centros de origen</h3>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <p>Lista de centros de origen por sucursal.</p>
                    <form method="POST" action="{{route('report.lista_origen')}}">
                        {{ csrf_field() }}
