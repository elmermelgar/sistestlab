...
@section('content')
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li>Existencias en inventario</li>
        </ol>
    </div>
    ...
    <div class="row">
        <div class="col-xs-8 col-xs-offset-2">
            <div class="x_panel">
                <div class="x_title">
                    <h3>Existencias en inventario</h3>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <p>Existencias de recursos en inventario por sucursal.</p>
                    <form method="POST" action="{{route('report.existencias')}}">
                        {{ csrf_field() }}
