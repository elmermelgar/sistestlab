...
@section('content')
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li>Lista de facturas anuladas</li>
        </ol>
    </div>
    ...
    <div class="row">
        <div class="col-xs-8 col-xs-offset-2">
            <div class="x_panel">
                <div class="x_title">
                    <h3>Lista de facturas anuladas</h3>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <p>Lista de facturas anuladas por sucursal en un rango de fechas.</p>
                    <form method="POST" action="{{route('report.lista_anulada')}}">
                        {{ csrf_field() }}
