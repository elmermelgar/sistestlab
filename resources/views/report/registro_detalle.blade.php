...
@section('content')
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li>Detalle de registro de caja</li>
        </ol>
    </div>
    ...
    <div class="row">
        <div class="col-xs-8 col-xs-offset-2">
            <div class="x_panel">
                <div class="x_title">
                    <h3>Detalle de registro de caja</h3>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <p>Registro detallado de caja por sucursal en un rango de fechas.</p>
                    <form method="POST" action="{{route('report.registro_detalle')}}">
                        {{ csrf_field() }}
