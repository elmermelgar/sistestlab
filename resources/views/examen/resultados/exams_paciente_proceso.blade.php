...
@section('content')
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <p>Aqui se muestran los examenes que aun no se les llenan resultados y los denegados para ser editados</p>
            <!-- start project list -->
                    ...
                    @if($examen->invoices->factura->sucursal_id == Auth::user()->account->sucursal_id)
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif($examen->estado->name == 'denegado' )
                                    <a href="{{url('results/'.$examen->exam->id.'/'.$examen->id.'/complete')}}"
                                       class="btn btn-primary bg-orange"><i class="fa fa-pencil-square"></i>
                                        Corregir
                                        resultados</a>
