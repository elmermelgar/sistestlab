                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                         ...
                         <form class="form-horizontal form-label-left" action="{{route('proveedores.update',$proveedor->id)}}" method="POST">
                             {{ csrf_field() }}
                                {{--Parte 1--}}
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-3 col-xs-12" for="last-name">Telefono: <span class="required">*</span>
                                        </label>
